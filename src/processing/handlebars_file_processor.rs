...
pub fn handlebars_file_processor(preprocessing_response: &PreprocessingResponse) -> Result<ProcessingResponse, server_status::ServerStatus> {
    ...
    let response = ProcessingResponse::new(&server_status::OK, &mime::HTML, &headers, &None, &preprocessing_response);
    Ok(response)
}
...
mod test {
    ...
    use crate::processing::handlebars_file_processor::*;
    use crate::util::server_status;
    use crate::util::mime;
    use crate::config::*;

    #[test]
    fn test_handlebars_file_processor() {
        ...
        let response = handlebars_file_processor(&preprocessor_response);
        match response {
            Ok(r) => {
